        ...
        <div class="panel-body">
          <div class = "row">
            <div class="col-lg-12">
              ...
              <?php endif; ?>
                  <form class="form" role="form" action="<?php echo base_url()?>index.php/AdminProduksiSensitizing/findByRollBeforeMutation" method="post">
                  <div class="col-lg-12">
                    <div class="col-lg-6">
                  ...
                  <form role="form" action="<?php echo base_url()?>index.php/AdminProduksiSensitizing/formMutasi" method="post">
                  <div class="col-lg-12">
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        foreach($listSensi as $row)
                        {
                        if($nomor%2){
                          echo "<tr>
                            <td><input type='checkbox' name='$row->NO_URUT_SENSI' value='$row->NO_URUT_SENSI'/></td>
                            ...
                            <td class='warning'>".$row->SHIFT_SENSI."</td>
                          ...
                          echo "<tr>
                            ...
                            <td class='info'>".$row->SHIFT_SENSI."</td>

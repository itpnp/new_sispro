...
<div id="page-wrapper">
 ...
 <!-- /.row -->
 <form class="form" role="form" action="<?php echo base_url()?>index.php/AdminProduksiSensitizing/saveLaporanSensitizing" method="post">
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-green">
       <div class="panel-heading">
         <h4>Laporan Produksi Sensitizing</h4>
       </div>

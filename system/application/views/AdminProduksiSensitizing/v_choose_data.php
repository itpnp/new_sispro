                      ...
                      <tbody>
                        ...
                        if($nomor%2){
                          echo "<tr>
                            ...
                            <td class='warning'><a href = 'formLaporanSensi/$row->KODE_ROLL@$row->NO_MUTASI@$row->TOTAL_BAHAN'>PILIH</a></td>
                          </tr>";
                        }else{
                          echo "<tr>
                            ...
                            <td class='info'><a href = 'formLaporanSensi/$row->KODE_ROLL@$row->NO_MUTASI@$row->TOTAL_BAHAN'>PILIH</a></td>
                          </tr>";
                        }
                          $nomor++;
                        }

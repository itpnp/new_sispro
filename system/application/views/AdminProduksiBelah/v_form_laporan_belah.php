...
<div id="page-wrapper">
 ...
 <!-- /.row -->
 <form class="form" role="form" action="<?php echo base_url()?>index.php/AdminProduksiBelah/saveLaporanBelah" method="post">
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-green">
       <div class="panel-heading">
         <h4>Laporan Produksi Belah</h4>
       </div>
       <div class="panel-body">
        <div class = "row">
          ...
          <?php if($this->session->flashdata('error')): ?>
            ...
            <?php endif; ?>
            <input type="hidden" name="kodeRoll" value="<?php if($kodeRoll!="") echo $kodeRoll; ?>" />
            <div class="form-group">
              <label>Kode Roll</label>
              <input class="form-control" name="kodeRollBaru" id="kodeRollBaru" value="<?php if($kodeRoll!="") echo $kodeRollBaru; ?>" readonly>
            </div>
            <div class="form-group">
        ...
        <br>
          <br>
            <div class="form-group">
              ...
              <input class="form-control" name="totalBahan" id="totalBahan" placeholder="totalBahan" value="<?php echo $totalBahan; ?>" onBlur = "numberWithCommas('totalBahan')" readonly>
            </div>
            <div class="form-group">

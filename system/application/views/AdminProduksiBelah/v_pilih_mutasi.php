                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        foreach($listBelah as $row)
                        {
                        if($nomor%2){
                          echo "<tr>
                            <td><input type='checkbox' name='$row->NO_URUT_BELAH' value='$row->NO_URUT_BELAH'/></td>
                            ...
                            <td class='warning'>".$row->SHIFT_BELAH."</td>
                          ...
                          echo "<tr>
                            ...
                            <td class='info'>".$row->SHIFT_BELAH."</td>
